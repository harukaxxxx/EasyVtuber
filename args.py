...
parser.add_argument("--auto_mouth", action="store_true")
parser.add_argument("--auto_mouth_method", type=str, default="microphone")
...
if args.output_webcam is None and args.output_dir is None:
    args.debug = True
